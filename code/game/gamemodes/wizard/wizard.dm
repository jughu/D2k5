...
/datum/game_mode/wizard
	...
	var/const/swaittime_l = 5000 //lower bound on time before intercept arrives (in tenths of seconds)
	var/const/swaittime_h = 7000 //upper bound on time before intercept arrives (in tenths of seconds)
...
/datum/game_mode/proc/name_wizard(mob/living/carbon/human/wizard_mob)
	...
	spawn(0)
		var/newname = strip_html(input(wizard_mob, "You are the Space Wizard. Would you like to change your name to something else?", "Name change", randomname) as null|text)
...
/obj/item/weapon/spellbook/attack_self(mob/user as mob)
	...
	if (src.temp)
		...
		dat += "<A href='byond://?src=\ref[src];spell_choice=15'>Sleep</A> ()<BR>"
		dat += "<HR>"
				...
				if(spell_type == "verb")
					switch(href_list["spell_choice"])
						...
						if ("15")
							...
							usr.mind.special_verbs += /client/proc/sleepify
							src.temp = "This spell puts a target within 4 tiles to sleep. Does not require wizard garb."
...
//	if(!usr.miming)No longer necessary.
	if(usr.gender=="male")
		playsound(usr.loc, pick('sound/spells/vs_chant_conj_hm.wav','sound/spells/vs_chant_conj_lm.wav','sound/spells/vs_chant_ench_hm.wav','sound/spells/vs_chant_ench_lm.wav','sound/spells/vs_chant_evoc_hm.wav','sound/spells/vs_chant_evoc_lm.wav','sound/spells/vs_chant_illu_hm.wav','sound/spells/vs_chant_illu_lm.wav','sound/spells/vs_chant_necr_hm.wav','sound/spells/vs_chant_necr_lm.wav'), 100, 1)
	else
		playsound(usr.loc, pick('sound/spells/vs_chant_conj_hf.wav','sound/spells/vs_chant_conj_lf.wav','sound/spells/vs_chant_ench_hf.wav','sound/spells/vs_chant_ench_lf.wav','sound/spells/vs_chant_evoc_hf.wav','sound/spells/vs_chant_evoc_lf.wav','sound/spells/vs_chant_illu_hf.wav','sound/spells/vs_chant_illu_lf.wav','sound/spells/vs_chant_necr_hf.wav','sound/spells/vs_chant_necr_lf.wav'), 100, 1)
